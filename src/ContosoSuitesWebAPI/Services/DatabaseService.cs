...
public class DatabaseService(string connectionString) : IDatabaseService
{
    ...
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the hotel")] int hotelId, [Description("The Minimum Date and Time")] DateTime dt)
    {
    ...
    [KernelFunction]
    [Description("Get all bookings for missing hotels rooms")]
